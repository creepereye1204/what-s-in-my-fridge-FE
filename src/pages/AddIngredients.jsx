  ...
  return (
    <div className="bg-blue-100 flex flex-col items-center font-sans text-center relative min-h-screen">
      ...
      <div className="w-full select-none">
        <ul className=" text-left Jua-font text-xl">
          {predefinedIngredients.map((ingredient) => (
            <li
              className="w-full px-4 py-2 flex items-center h-25 border-b-4 border-blue-900 mt-4 mb-4"
              key={ingredient}
            >
      ...
      {ingredientCount > 0 && (
        ...
        <button
          className="Jua-font border-2 border-blue-900 bg-blue-200 h-10 w-16"
